...
$conf['fast_404_exts'] = '/^(?!robots).*\.(png|gif|jpe?g|css|js|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/i';
...
$conf['fast_404_exts'] = '/^(?!robots)^(?!sites\/default\/private).*\.(png|gif|jpe?g|css|js|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/i';

# If you are using the Advanced Help module, the following config may be used
# to allow paths starting with 'help'.
$conf['fast_404_exts'] = '/^(?!help\/)(?!robots).*\.(png|gif|jpe?g|css|js|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/';
...
$conf['fast_404_exts'] = '/\.(png|gif|jpe?g|css|js|ico|swf|flv|cgi|bat|pl|dll|exe|asp|php|html?|xml)$/i';
...
$conf['fast_404_HTML_error_page'] = './404page.html';
