...
class PrcCsvGenreMigration extends Migration {
  ...
  public function __construct($arguments = array()) {
    ...
    $this->description = t('Migrate genre terms from Csv to taxonomy terms');

    $path = drupal_get_path('module', 'prc_migrate') . '/data/genre.csv';
    $columns = array(
      0 => array('id', t('ID')),
      1 => array('name', t('Name')),
