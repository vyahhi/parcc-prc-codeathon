...
#  Results in reverse alphabetical order (second click)
  ...
  Scenario: Create default entities and nodes
    ...
    And entities of type "prc_trt" and bundle "system_check":
      ...
      | 1415932389 | Check AA   | 10                      | laptop            | win7                   | 17                 | 1                     | 1         | 24                        | ff            | 34                    | TRUE                          | TRUE                             | TRUE                         | 1027                          | 768                            | @nid[School One @timestamp] |
      | 1429932389 | Check BB   | 30                      | laptop            | win7                   | 17                 | 1                     | 1         | 24                        | ff            | 34                    | TRUE                          | FALSE                            | TRUE                         | 1027                          | 768                            | @nid[School One @timestamp] |
      | 1411932389 | Check CC   | 5                       | laptop            | win7                   | 17                 | 1                     | 1         | 24                        | ff            | 34                    | TRUE                          | TRUE                             | TRUE                         | 1027                          | 768                            | @nid[School One @timestamp] |
