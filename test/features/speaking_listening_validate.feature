...
Feature: PRC-1419 Speaking and Listening - Add/Edit Resource - Form Validation
  ...
  Scenario: Validate file type
    ...
    When I press "Save"
    Then I should see the error message containing "The specified file trt_upload_schools_valid.csv could not be uploaded. Only files with the following extensions are allowed: brf doc docx mp4 pdf xls xlsx."
