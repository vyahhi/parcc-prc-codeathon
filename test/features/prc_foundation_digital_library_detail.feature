...
Feature: Digital Library - Item Detail Page Responsive Behavior (PRC-751)
  ...
  Scenario: Digital library item detail page responsive behavior matches style guide
    ...
    # We'd rather test on width, but still haven't determined why those values are drifting.
    # And ".group-left" should have a "width" css value of "341px"
    And ".group-left" should have an "class" attribute value of "large-8 columns group-left"
    ...
    And ".group-right" should have an "class" attribute value of "large-4 columns group-right"
    And ".group-right" should have a "padding-right" css value of "15px"
    And ".group-right .field-name-field-grade-level-unlimited" should be visible
    ...
    And ".group-left" should be "785px" wide within a margin of "1%"
  ...
  Scenario: Digital library item detail page styling matches style guide
    ...
    And ".group-left .breadcrumb" should have a "padding-bottom" css value of "8px"
    ...
    # Next step has no visual regressions, but disabling due to issues with step that tests computed pixel values.
    ...
    And ".prc_digital_library_add_to_favorites a" should have a "background-image" css value of "url('sites/all/themes/prc_foundation/images/authenticated-se60a58fb9b.png')"
    And ".page-node.node-type-digital-library-content .group-right ul.links .flag-like_content a, .gallery-main .view-content .columns ul.links .flag-like_content a" should have a "background-image" css value of "url('sites/all/themes/prc_foundation/images/authenticated-se60a58fb9b.png')"
    And "li.pinit a" should have a "background-image" css value of "url('sites/all/themes/prc_foundation/images/main-sc6a635ad1f.png')"
