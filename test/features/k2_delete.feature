...
Feature: Delete Formative Instructional Task Resource
  ...
  Background:
    ...
    And formative instructional task content:
      | resource name       | resource type | file                          | faux standard | faux subject | grade level | permissions | status |
      | Resource @timestamp | Task          | testfiles/GreatLakesWater.pdf | Standard      | Subject      | 1st Grade   | public      | 1      |
