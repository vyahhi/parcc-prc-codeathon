@api @trt @capacity_check @prc-801 @prc-1051 @prc-994 @prc-1065
...
#  Speed of connection: <#>
  ...
  # PRC-1065 Change pass requirements on device capacity from 1 to 0
  # PRC-994 Rounding
  ...
  Examples:
    ...
    | 100      | 5       | 4        | 10           | 4        | Wired           | 100 Mbps    | 600           | 500              | 11               | -6               | 5                  | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | Exceeds Requirements                          | Meets Minimum Requirements \(for no Caching\) | Requires Test Caching                         | Exceeds Requirements                                                                                                          | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. |
    | 55       | 5       | 4        | 10           | 4        | Wired           | 100 Mbps    | 600           | 5                | 7                | -2               | 0.091              | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | Meets Minimum Requirements \(for no Caching\) | Exceeds Requirements                          | Requires Test Caching                         | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           | Exceeds Requirements                                                                                                          | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. |
    | 100      | 5       | 4        | 10           | 4        | Wired           | 100 Mbps    | 600           | 4                | 11               | -6               | 0.04               | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | Requires Test Caching                         | Exceeds Requirements                          | Meets Minimum Requirements \(for no Caching\) | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. | Exceeds Requirements                                                                                                          | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           |
    | 100      | 22      | 5        | 5            | 5        | Wired           | 100 Mbps    | 600           | 12               | 22               | 0                | 0.12               | Passed        | Failed            | Instructions or next steps go here. | Can't be blank                      | Exceeds Requirements                          | Requires Test Caching                         | Meets Minimum Requirements \(for no Caching\) | Exceeds Requirements                                                                                                          | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           |
    | 600      | 66      | 6        | 6            | 6        | Wired           | 100 Mbps    | 600           | 50               | 111              | -45              | 0.083              | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | Meets Minimum Requirements \(for no Caching\) | Exceeds Requirements                          | Requires Test Caching                         | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. | Exceeds Requirements                                                                                                          |
    | 1000     | 5       | 4        | 10           | 4        | Wired           | 100 Mbps    | 600           | 125              | 111              | -106             | 0.125              | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | Exceeds Requirements                          | Requires Test Caching                         | Meets Minimum Requirements \(for no Caching\) | Exceeds Requirements                                                                                                          | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           |
    | 500      | 150     | 2        | 6            | 2        | Wired           | 100 Mbps    | 600           | 2                | 92               | 58               | 0.004              | Passed        | Failed            |                                     | Instructions or next steps go here. | Requires Test Caching                         | Exceeds Requirements                          | Meets Minimum Requirements \(for no Caching\) | Provide explanation of what Requires Test Caching means \(will not be able to run successful assessment\) and any next steps. | Exceeds Requirements                                                                                                          | Provide explanation of what Meets Minimum Requirements \(for no Caching\) means and any next steps.                           |
