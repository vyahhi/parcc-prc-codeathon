...
#  Speed of connection: <#>
  ...
  Examples:
    ...
    | 55       | 5       | 4        | 10           | 4        | Wired           | 100 Mbps    | 600           | 5                | 6                | -1               | 0.091              | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | OK               | Good                  | Poor                  | Provide explanation of what OK means and any next steps.                                                     | Good                                                                                                         | Provide explanation of what poor means \(will not be able to run successful assessment\) and any next steps. |
    ...
    | 600      | 66      | 6        | 6            | 6        | Wired           | 100 Mbps    | 600           | 50               | 110              | -44              | 0.083              | Failed        | Passed            | Instructions or next steps go here. | Can't be blank                      | OK               | Good                  | Poor                  | Provide explanation of what OK means and any next steps.                                                     | Provide explanation of what poor means and any next steps.                                                   | Good                                                                                                         |
