...
Feature: PRC-553 Social Media: PD Content "Like"
  ...
  Acceptance Criteria
  In the Professional Development page where courses are displayed, a link/icon shall display "Like" and the number of users who clicked that link, like "Like this item".
