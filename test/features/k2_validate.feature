@api @k2 @fit @prc-1239 @prc-1524 @permissions
Feature: PRC-1239 Formative Instructional Task - Add/Edit Resource - Form Validation
  ...
  Scenario: Validate file type
    ...
    When I press "Save"
    Then I should see the error message containing "The specified file trt_upload_schools_valid.csv could not be uploaded. Only files with the following extensions are allowed: brf doc docx mp4 pdf xls xlsx pptx."
