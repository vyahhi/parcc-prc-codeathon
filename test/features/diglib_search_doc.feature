...
#    AC2 Restrictions on the file format include: DOC, DOCX
...
#      File format
  ...
  Scenario: Attach a DOCX file and search on it
    ...
    And I follow "Edit"
    Then I attach the file "testfiles/FireflyIpsum.docx" to "edit-field-document-und-0-upload"
