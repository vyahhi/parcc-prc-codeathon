@api @trt @system_check @district @export @prc-1069
Feature: PRC-1069 Export System Check Data - State Readiness
  As a State Admin,
  I want to export all system checks data for the schools in my state
